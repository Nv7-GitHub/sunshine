...
const T_RISE = 0.2;               // s, 0 → full deflection while held (display mirror; real ramps in Rust lib.rs)
const T_FALL = 0.25;              // s, full deflection → 0 while released — hold = full stick, like a joystick
